 ...
 * Todo (Strategien zur Wiederverwendung)
 */
...
public class Container {
    ...
    // Todo (Bewertung Thread-Safe) --> ja
    // Nachteil dieser Variante:
    // Todo (Nachteile der Variante) --> verbraucht direkt Speicher
    ...
    public void startEingabe() throws ContainerException, Exception {
        ...
        while ( true ) {
            ...
            if (  strings[0].equals("store")  ) {
                // Beispiel-Code zu Demo-Zwecken
                // Hinzufügen eines Employee-Objekts
                Employee employee = new Employee();
                employee.setPid(2);
                this.addEmployee( employee );

                // Und das eigentliche Abspeichern
                this.store();
            }
